...
## Results & Discussion ##
<p class="justify-text">
    The design accomplished all the intended tasks. Testbenches for both `lab2_dsh.sv` and `sevensegment.sv` modules were succesfully simulated in Questa to verify correct 
