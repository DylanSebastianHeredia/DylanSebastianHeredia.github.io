...
<p class="justify-text">
    ...
    `synchronizer.sv`, `kpad_fsm.sv`, and `kpad_decoder.sv` modules were succesfully simulated in Questa to verify correct functionality of reading rows, debouncing columns, syncing columns, decoding 
    rows and columns, displaying digits, updating digits from right to left, and ensuring all specifications were met. *Figures 18-11* show the waveforms
    for modules of interest.
...
*Figure 8: Multiplexing, digit updating, row scanning, and fsm functions were all validated in Questa for* `lab3_dsh.sv`.

<img src="images/E155_Lab3/synchronizer_tb.png" alt="synchronizer testbench" style="width:100%; border-radius: 15px;">
*Figure 9: All asynchronous singals were synched in Questa for* `synchronizer.sv`.

<img src="images/E155_Lab3/kpad_fsm.png" alt="kpad_fsm testbench" style="width:100%; border-radius: 15px;">
*Figure 10: For all states, current and next state logic for matched expectations in Questa for* `kpad_fsm.sv`.

<img src="images/E155_Lab3/kpad_decoder.png" alt="kpad_decoder testbench" style="width:100%; border-radius: 15px;">
*Figure 11: All row and column combinations for the 16 keys were successfully decoded by* `kpad_decoder.sv`.
...
*Figure 12:* `Prompt A` *RLT schematic of the SystemVerilog script produced by ChatGPT 5.0.*
...
*Figure 13:* `Prompt B` *RLT schematic of the SystemVerilog script produced by ChatGPT 5.0.*