...
## Calculations ##
<p class="justify-text"> 
  The prescaler (`PSC`) value divides the system clock frequency of 80MHz by any factor between 1 and 65,536. *Figure 1* anf *Figure 2* below show calculations for the maximum and minimum
...
<div style="flex: 2; width: 300px;">
  ...
  <p>
    *Figure 1: Frequency range based on* `PSC = 79`.
  </p>
</div>
...
<div style="flex: 2; min-width: 300px;">
  ...
  <div style="height: 10px;"></div>
  <p>
    *Figure 2: Duration range based on* `PSC = 3000`.
  </p>
</div>
</div>
...
<p class="justify-text"> 
  ...
  This setup provided sufficient volume while protecting the MCU from excessive current draw. *Figure 4* below shows the electrical schematic for the design. 
</p>
...
<p class="justify-text"> 
    All designs were successfully implemented. The lab took __24 hours__ to complete. 
</p>

<p class="justify-text"> 
   The lab reinforced the importance of prcise timers configuration and sequencingin PWM updates for digital audio. Notable challenges included ensuring smooth PWM output when changing 
